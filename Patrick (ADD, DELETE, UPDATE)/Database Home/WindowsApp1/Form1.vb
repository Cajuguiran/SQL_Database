...
Public Class Form1
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If MsgBox("Are you sure to save this record?", vbQuestion + vbYesNo) = vbYes Then
            openCon()
            sql = "INSERT INTO tblmembersinfo (studno, studlastname, studefirstname, studmiddle, studaddress, studgender, studcontact, studcourse)" _
    ...
    Private Sub ListView1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListView1.SelectedIndexChanged
        ...
        For i = 0 To ListView1.SelectedItems.Count - 1
            ...
            openCon()
            sql = "Select * from tblmembersinfo where studno = '" & selected & "'"
            cmd = New NpgsqlCommand(sql, cn)
            dr = cmd.ExecuteReader
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        If MsgBox("Are you sure to update this record?", vbExclamation + vbYesNo) = vbYes Then
            openCon()
            sql = "UPDATE tblmembersinfo SET studno = '" & (Me.txtnumber.Text) & "' , studlastname = '" & (Me.txtlastname.Text) & "', studefirstname = '" & (Me.txtfirstname.Text) & "', studmiddle = '" & (Me.txtmiddle.Text) & "', studaddress =  '" & (Me.txtaddress.Text) & "', studgender = '" & (Me.cmbgender.Text) & "', studcontact =  '" & (Me.txtcontact.Text) & "', studcourse = '" & (Me.cmbcourse.Text) & "' where studno = '" & selected & "'"
            cmd = New NpgsqlCommand(sql, cn)
            cmd.ExecuteNonQuery()
            cn.Close()
            PopListView()
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        If MsgBox("Are you sure to delete this record?", vbExclamation + vbYesNo) = vbYes Then
            Dim query As String = "DELETE FROM tblmembersinfo WHERE studno = '" & (txtnumber.Text) & "'"
